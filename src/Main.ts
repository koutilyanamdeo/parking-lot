...
import { DefaultParkingStrategy } from "./strategy/ParkingTicketStrategy";
// ------------------------------
// Create Panels
// ------------------------------
const entryPanel = new EntryPanel();
const parkingTicketStrategy = new DefaultParkingStrategy();
const exitPanel = new ExitPanel(parkingTicketStrategy);
